        ...
        <div className="container-fluid">
            ...
            <main className="md:max-w-6xl md:mx-auto flex flex-col md:flex-row">
                <aside className="flex-initial md:w-1/4">
                    ...
                    <div className="w-full p-2">
                        <div className="relative h-10 w-full min-w-[200px]">
                            <select onChange={(e) => { filterItems(e.target.value)}} className="peer h-full w-full rounded-[7px] border border-blue-gray-200 border-t-transparent bg-transparent px-3 py-2.5 font-sans text-sm font-normal text-blue-gray-700 outline outline-0 transition-all placeholder-shown:border placeholder-shown:border-blue-gray-200 placeholder-shown:border-t-blue-gray-200 empty:!bg-red-500 focus:border-2 focus:border-pink-500 focus:border-t-transparent focus:outline-0 disabled:border-0 disabled:bg-blue-gray-50">
                ...
                <section className="flex-initial md:w-3/4">
                    <div className="grid grid-cols-4 gap-4">
                        {data.length && data.map((item: any) => {
                            if (!item.hide) {
                                return <div className={`border rounded-xl ${item.stock > 40 ? 'bg-green-400' : 'bg-red-400'} p-4`}>
                                    <figure>
